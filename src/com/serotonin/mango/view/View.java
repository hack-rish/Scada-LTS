...
System.out.println("????????????????????GET ?MAP  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????GET MAP  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????GET MAP  VIEW VIEW DATA?????????????????????????????");
System.out.println("?????????????????????MAP  VIEW DATA?????????????????????????????");
System.out.println(this.mapData.toString());
System.out.println("?????????????????????GET MAP  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????GET MAP VIEW  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????GET MAP VIEW  DATA?????????????????????????????");
System.out.println("?????????????????????GET MAP  VIEW DATA?????????????????????????????");
...
System.out.println("?????????????????????SET MAP  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????SET MAP  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????SET MAP  VIEW VIEW DATA?????????????????????????????");
System.out.println("?????????????????????SET MAP  VIEW DATA?????????????????????????????");
System.out.println(this.mapData.toString());
System.out.println("?????????????????????SET MAP  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????SET MAP VIEW  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????SET MAP VIEW  DATA?????????????????????????????");
System.out.println("?????????????????????SET SET MAP  VIEW DATA?????????????????????????????");
System.out.println("?????????????????????SET MAP  VIEW DATA?????????????????????????????");
}
